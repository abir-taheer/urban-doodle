 ...
 */
const session_id_cookie = "";       // String, Name of cookie referencing ID information -- Can be left as is
const session_voting_cookie = "";   // String, Name of cookie referencing voting information -- Can be left as is
